...
public class MConstans {
    ...
    public static final String TESTING_RESULT_MISTAKES = "mstks";
    public static final String TESTING_RESULT_PERCENT = "prcnt";
    public static final String TESTING_RESULT_NOT_CHECKED_COUNT = "not_chckd";
    public static final String TESTING_RESULT_QUESTIONS_COUNT = "qstns_cnt";
}
