 ...
 */
public class MBarView extends View {
    ...
    public MBarView(Context context, AttributeSet attrs) {
        ...
        rect = new Rect();
        topMargin = MBarUtils.dip2px(context, 5);
        int textSize = MBarUtils.sp2px(context, 15);
        barWidth = MBarUtils.dip2px(context, 22);
        MINI_BAR_WIDTH = MBarUtils.dip2px(context, 22);
        BAR_SIDE_MARGIN = MBarUtils.dip2px(context, 22);
        TEXT_TOP_MARGIN = MBarUtils.dip2px(context, 5);
        textPaint = new Paint();
    ...
    @Override protected void onDraw(Canvas canvas) {
        ...
        if (percentList != null && !percentList.isEmpty()) {
            for (Float f : percentList) {
                 ...
                 */
                rect.set(BAR_SIDE_MARGIN * i * (i - 1), topMargin + (int) ((getHeight()
                                - topMargin
                                - bottomTextHeight
